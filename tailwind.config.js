  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        dark: {
          bg: {
            ...
            accent: '#475569',      // Accent backgrounds
          },
          text: {
            primary: '#f8fafc',     // Almost white
            secondary: '#cbd5e1',   // Light gray
            tertiary: '#94a3b8',    // Muted text
            accent: '#64748b',      // Accent text
          },
          border: {
      ...
      spacing: {
        ...
        '88': '22rem',
        '128': '32rem',
        // Responsive spacing utilities using relative units
        'responsive': {
          'xs': '0.25rem',   // 4px
          'sm': '0.5rem',    // 8px
          'md': '0.75rem',   // 12px
      ...
      boxShadow: {
        ...
        'dark-strong': '0 10px 40px -10px rgba(0, 0, 0, 0.5), 0 2px 10px -2px rgba(0, 0, 0, 0.4)',
      },
      animation: {
      ...
      minHeight: {
        'screen-dynamic': '100dvh', // Dynamic viewport height for mobile
      }
    },
  },
  plugins: [],
